...
void UUIHelper::BPF_SetVirtualCursorWidget(ULocalPlayer* _player, TEnumAsByte<EMouseCursor::Type> Cursor, UUserWidget* Widget) {
}

void UUIHelper::BPF_SetLastFocusedButton(UWidget* _lastFocusedButton) {
}

void UUIHelper::BPF_SetCursorPosition(const FVector2D& _vCursor) {
}
...
FVector2D UUIHelper::BPF_GetCursorPosition() {
    return FVector2D{};
}
