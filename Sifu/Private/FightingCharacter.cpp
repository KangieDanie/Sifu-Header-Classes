...
void AFightingCharacter::MulticastActivateCollision_Implementation(const FString& _contextString, bool _bActivate, bool _bLetStaticMeshOn, bool _bBlockTargettedAttacks) {
}
