...
void UAkComponent::OnComponentStartOverlap(AActor* OverlappedActor, AActor* OtherActor) {
}

void UAkComponent::OnComponentEndOverlap(AActor* OverlappedActor, AActor* OtherActor) {
}
